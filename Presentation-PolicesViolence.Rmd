...
## Razzismo?
<small>
Popolazione di carnagione nera/scura negli USA è di ~40 milioni nel 2020, mentre di ~200 milioni per la popolazione bianca.
</small>
```{r, echo=FALSE}
...
calendR(
        ...
        special.col =  "#BD0026",
        low.col = "#a1a2af",
        subtitle = "Non è cambiato molto",
        title= "Tutti i giorni del 2021"
        )
```
...
```{r, echo=FALSE}
#raggruppimo per etnia, causa del decesso, mental illness (se la vittima era in una condizione mentale particolare).
